...
public class HomeWorkParameterized {
    ...
    static Stream<Arguments> commonSearchDataProvider() {
        return Stream.of(
                ...
                Arguments.of("Богемская рапсодия", "песня британской рок-группы Queen из альбома A Night at the Opera"),
                Arguments.of("Фредди Меркьюри", "британский певец парсийского происхождения")
        );
    }
